...
export declare type GroupBySelection = Pick<GroupBy, "aggList" | "apply" | "count" | "first" | "last" | "max" | "mean" | "median" | "min" | "numUnique" | "quantile" | "sum"> & {
    [inspect](): string;
};
export declare type PivotOps = Pick<GroupBy, "count" | "first" | "max" | "mean" | "median" | "min" | "sum"> & {
    [inspect](): string;
};
export declare function GroupBy(df: DataFrame, by: string[], maintainOrder?: boolean, downsample?: boolean, rule?: string, downsampleN?: number): GroupBy;
export {};
