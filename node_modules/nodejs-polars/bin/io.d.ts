 ...
 */
export declare function scanCSV(options: Partial<ReadCsvOptions>): LazyDataFrame;
export declare function scanCSV(path: string): LazyDataFrame;
export declare function scanCSV(path: string, options: Partial<ReadCsvOptions>): LazyDataFrame;
export declare function readParquet(): void;
export declare function scanParquet(): void;
export declare function readIPC(): void;
export declare function scanIPC(): void;
export declare function scanJSON(): void;
